...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-8">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[36px] border border-slate-200/80 bg-white/80 shadow-[0_30px_100px_-55px_rgba(15,23,42,0.6)] backdrop-blur-xl lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="flex items-center justify-center px-6 py-10 sm:px-10">
          <div className="w-full max-w-md">
            ...
            <div className="space-y-4">
              <input
                className="h-12 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10"
                placeholder="Email"
              />
              ...
              <button
                ...
                className="flex h-12 w-full items-center justify-center rounded-2xl bg-slate-950 px-4 text-sm font-semibold text-white shadow-[0_16px_40px_-18px_rgba(15,23,42,0.85)] transition hover:bg-slate-800"
              >
                Login
              </button>
            </div>
